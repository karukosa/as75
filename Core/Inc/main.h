...
/* Private defines -----------------------------------------------------------*/
#define LED_C3_Pin GPIO_PIN_2
#define LED_C3_GPIO_Port GPIOE
#define LED_C4_Pin GPIO_PIN_3
#define LED_C4_GPIO_Port GPIOE
#define LED_C5_Pin GPIO_PIN_4
#define LED_C5_GPIO_Port GPIOE
#define LED_C6_Pin GPIO_PIN_5
#define LED_C6_GPIO_Port GPIOE
#define LED_C7_Pin GPIO_PIN_6
#define LED_C7_GPIO_Port GPIOE
...
#define LED_LW_Pin GPIO_PIN_8
#define LED_LW_GPIO_Port GPIOE
#define LED_HW_Pin GPIO_PIN_9
#define LED_HW_GPIO_Port GPIOE
...
#define LED_P1_GPIO_Port GPIOD
#define LED_P2_Pin GPIO_PIN_1
#define LED_P2_GPIO_Port GPIOD
#define LED_P3_Pin GPIO_PIN_2
#define LED_P3_GPIO_Port GPIOD
#define LED_P4_Pin GPIO_PIN_3
#define LED_P4_GPIO_Port GPIOD
#define LED_P5_Pin GPIO_PIN_4
#define LED_P5_GPIO_Port GPIOD
#define LED_P6_Pin GPIO_PIN_5
#define LED_P6_GPIO_Port GPIOD
#define LED_START_Pin GPIO_PIN_6
...
#define LED_C1_Pin GPIO_PIN_0
#define LED_C1_GPIO_Port GPIOE
#define LED_C2_Pin GPIO_PIN_1
#define LED_C2_GPIO_Port GPIOE
